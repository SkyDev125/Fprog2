...
def obtem_col(inter: intersecao) -> str:
    ...
    Args:
    - inter: A new Data structure called "intersecao" generated by cria_intersecao.
...
def intersecoes_iguais(inter1: any, inter2: any) -> bool:
    ...
    Returns:
    - True if the arguments are intersections and equal, False otherwise.
    """
...
def obtem_intersecoes_adjacentes(
    ...
    """
    Returns the adjacent intersections of the given intersecao based on a maximum intersecao.
    ...
    Returns:
    - A tuple containing the adjacent intersections of the given intersecao within the maximum
    intersecao range.
    """
...
def ordena_intersecoes(intersecoes: tuple[intersecao]) -> tuple[intersecao]:
    ...
    Returns:
    - A tuple of intersections sorted by their position from left to right and bottom to top
...
def eh_pedra_branca(p: pedra) -> bool:
    ...
    Args:
    - p: A new Data structure called "pedra" generated by any of the cria_pedra functions
    (branca, preta, neutra).
...
def cria_goban(
    ...
    Raises:
    - ValueError: If the given size, white stones or black stones are invalid.
    """
...
def cria_copia_goban(go: goban) -> goban:
    ...
    Args:
    - go: A new Data structure called "goban" generated by any of the cria_goban functions.
...
def obtem_ultima_intersecao(go: goban) -> intersecao:
    """
    Returns the coordinates of the last intersection (top right) of the given goban.
...
def eh_intersecao_valida(go: goban, inter: intersecao) -> bool:
    """
    Verifies if the given intersecao is within the territory of the goban.
    ...
    Returns:
    - True if the intersecao is within the territory of the goban, False otherwise.
    """
...
def gobans_iguais(go1: goban, go2: goban) -> bool:
    ...
    Args:
    - go1: A new Data structure called "goban" generated by any of the cria_goban functions.
    - go2: A new Data structure called "goban" generated by any of the cria_goban functions.
...
def goban_para_str(go: goban) -> str:
    """
    Returns a string representation of a goban, where each intersecao is represented by an X, O or . depending on
...
def obtem_adjacentes_diferentes(
    ...
    Returns:
    - A tuple of intersections representing the adjacent intersections that are different
...
def obtem_pedras_jogadores(go: goban) -> tuple[int, int]:
    ...
    Returns:
    - A tuple of integers representing the black and white stones in the territory respectively
    (white, black).
    """
...
def calcula_pontos(go: goban) -> tuple[int, int]:
    ...
    Returns:
    - A tuple of integers representing the black and white points respectively (white, black).
    """
...
def eh_jogada_legal(go: goban, inter: intersecao, p: pedra, prev_go: goban) -> bool:
    ...
    - p: A new Data structure called "pedra" generated by any of the cria_pedra functions
    (branca, preta, neutra).
    - prev_go: A new Data structure called "goban" generated by any of the cria_goban functions
...
def convert_intersecao(inter: intersecao) -> tuple[int, int]:
    """
    Converts the intersecao coordinates to usable values (A -> 0) (1 -> 0).
