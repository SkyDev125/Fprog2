...
from main import *  # <--- Change the name projName to the file name with your project
...
class TestPublicIntersecao:
    ...
    def test_6(self):
        ...
        assert ("A1", "B1", "B2", "A3") == tuple(
            intersecao_para_str(i) for i in ordena_intersecoes(tup)
        )
...
class TestPublicGoban:
    ...
    def test_4(self):
        ...
        for i in ib:
            coloca_pedra(g, str_para_intersecao(i), b)
        for i in ip:
            coloca_pedra(g, str_para_intersecao(i), p)
 ...
 1 . . O . . . . . .  1
   A B C D E F G H I"""
    ...
    def test_6(self):
        ...
        assert tuple(intersecao_para_str(i) for i in liberdades) == (
            "E3",
            "F3",
            "G4",
            "D5",
    ...
    def test_7(self):
        ...
        assert tuple(intersecao_para_str(i) for i in terr[0]) == (
            "A1",
            "B1",
            "A2",
            "B2",
...
class TestPublicEhJogadaLegal:
 ...
 1 X X O . . . . . .  1
   A B C D E F G H I"""
        assert (
            (not eh_jogada_legal(g, cria_intersecao("B", 2), p, l))
    ...
    def test_1(self):
        ...
        assert (
            turno_jogador_offline(
                g, cria_pedra_preta(), cria_goban_vazio(9), "B10\nB2\nG5\n"
            )
            == ref
        )
...
REF_GO_PUBLIC_JOGO1 = """Branco (O) tem 0 pontos
...
REF_GO_PUBLIC_JOGO2 = """Branco (O) tem 62 pontos
